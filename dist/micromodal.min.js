...
t.forEach(function(o){o.addEventListener("click",function(o){return e.showModal(o)})})}},{key:"showModal",value:function(e){this.activeElement=document.activeElement,this.modal.setAttribute("aria-hidden","false"),this.modal.classList.add("is-open"),this.setFocusToFirstNode(),this.scrollBehaviour("disable"),this.addEventListeners(),this.config.onShow(this.modal,e)}},{key:"closeModal",value:function(e){var o=this.modal
